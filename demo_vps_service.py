...
━━━ 3. Загрузить модель ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    ollama pull qwen2.5:1.5b          # ~1GB, влезет в 4GB RAM
...
def main() -> None:
    ...
    parser.add_argument(
        "--model",
        default=None,
        help="Имя модели (по умолчанию: qwen2.5:1.5b или из env OLLAMA_LLM_MODEL)",
    )
    ...
    model = args.model or os.environ.get("OLLAMA_LLM_MODEL", "qwen2.5:1.5b")
