...
class OllamaEmbedder(EmbeddingProvider):
    ...
    # Ollama устанавливает num_ctx=2048 по умолчанию для embedding-моделей.
    # При ~4 символа/токен безопасный предел — 2000 символов.
    # Для RAG это нормально: первые 2000 символов чанка несут основной смысл.
    _MAX_CHARS = 2000
